...
app.get('/characters', function(req, res) {
    res.render('characters', {repo: repo, version: __version, locales: __conf.locales, gamemodes:  __staticGametypes });
  });
  app.get('/gamerules', function(req, res) {
    res.render('gamerules', {repo: repo, version: __version, locales: __conf.locales, gamemodes:  __staticGametypes });
  });
  /**
   * IO : Ping
   */
